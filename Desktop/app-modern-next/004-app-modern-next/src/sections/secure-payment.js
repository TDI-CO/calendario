...
const data = {
  subTitle: 'SEGURIDAD EN PAGOS',
  title: 'Recibimos tanto pagos en efectivo como transferencias',
  description:
    'Nos aseguramos de revisar cada transacción para así mantener una seguridad monetaria, esto lo hacemos mediante un código referente en la cuenta de cobro.',
};

export default function SecurePayment() {
  return (
    <section id='securitypays' sx={{ variant: 'section.securePayment' }}>
